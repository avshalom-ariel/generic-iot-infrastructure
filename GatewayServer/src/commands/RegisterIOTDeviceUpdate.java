...
public class RegisterIOTDeviceUpdate implements Command {
    private final MongoDBManager mongoDBManager = MongoDBManager.getInstance();
    private final JsonObject data;

    public RegisterIOTDeviceUpdate(JsonObject data) {
        this.data = data;
    ...
    public void execute(RespondableChannel respondableChannel) {
        JsonObject respond = mongoDBManager.registerIOTDeviceUpdate(data);
